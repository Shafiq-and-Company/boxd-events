      ...
      <div className={styles.footerBottom}>
        <div className={styles.footerBottomContent}>
          ...
          <div className={styles.socialLinks}>
            <a href="#" className={styles.socialLink} title="Discord">
            ...
            <a href="#" className={styles.socialLink} title="Twitch">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path d="M11.571 4.714h1.715v5.143H11.57l-1.715 1.715V4.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0H6zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714V11.143z"/>
              </svg>
            </a>
          </div>
        </div>
